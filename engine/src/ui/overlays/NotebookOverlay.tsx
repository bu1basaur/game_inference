            ...
            <div className="overlay-panel-dark notebook-container">
                ...
                <div className="notebook-sidebar">
                    ...
                    {SUSPECTS.map((s) => (
                        <div
                            ...
                            className={`notebook-sidebar-item${selected.id === s.id ? " active" : ""}`}
                        >
                            {s.name}
                        </div>
                    ))}
                ...
                <div className="notebook-detail">
                    ...
                    <div className="notebook-portrait">
                        {selected.imageKey
                            ? <img src={`/assets/game/images/${selected.imageKey}.png`} />
                            : "사진 없음"
                        }
                    </div>
                    ...
                    <div className="notebook-info">
                        ...
                        <div className="notebook-info-row" style={{ marginTop: 8 }}>
                            <span className="notebook-info-label">비고</span>
                            <span className="notebook-info-desc">{selected.description}</span>
                        </div>
                    </div>

                    <div className="overlay-btn" style={{ marginTop: "auto", alignSelf: "flex-start" }} onClick={handleClose}>
                        닫기
                    </div>
                </div>
            </div>
