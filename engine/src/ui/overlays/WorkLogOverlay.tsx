...
const WorkLogOverlay = () => {
    ...
    return (
        <div className="overlay-backdrop">
            <div className="overlay-panel-dark" style={{ width: 580, display: "flex", flexDirection: "column" }}>
                    ...
                    {entries.length === 0 ? (
                        ...
                        entries.map((entry) => (
                            <div key={entry.id} className="worklog-entry">
                                ...
                                <span className="worklog-content">{entry.content}</span>
                            </div>
                        ))
                    )}
                </div>
                ...
                <div className="worklog-footer">
                    <div className="overlay-btn" onClick={handleClose}>닫기</div>
                </div>
            </div>
        </div>
    );
